        ...
        <div class="lg:w-2/4 mx-auto py-8 px-6 bg-white rounded-xl">
            ...
            <div class="mb-6">
                <form action="/" class="flex flex-col space-y-4" method="POST">
                    @csrf
                    <input type="text" name="title" placeholder="The todo tiltle" class="py-3 px-4 bg-gray-100 rounded-xl"  id="">

                    <textarea name="description" id="" placeholder="The todo description" class="py-3 px-4 bg-gray-100 rounded-xl"></textarea>

                    <button class="w-28 py-4 bg-green-500 text-white rounded-xl">Add</button>
                </form>
            </div>
